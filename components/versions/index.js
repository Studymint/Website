          ...
          <div className="lg:py-6 lg:pr-16">
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold">v0.0.1</p>
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold">v1.0.0</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold">v1.1.0</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold">v2.0.0</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              ...
              <div className="pt-1">
                <p className="mb-2 text-lg font-bold">New Features are cooking...</p>
                <p className="text-gray-700" />
              </div>
            </div>
          </div>
